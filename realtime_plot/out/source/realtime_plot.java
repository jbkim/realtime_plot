/* autogenerated by Processing revision 1277 on 2022-11-18 */
...
public class realtime_plot extends PApplet {
 ...
 public void portName(int n) 
{
 ...
 public void toggleONOFF(boolean onoff) {
  if(onoff == true) {
 ...
 public void serialEvent (Serial myPort)
{
  ...
  if (inString != null) {
    ...
    inByte = PApplet.parseFloat(inString);   // convert to a number.
    inByte = map(inByte, 0, nPoints1, 0, height); //map to the screen height.
    // newData = true; 
 ...
 public void pcProcessData(char rxch)
{
    if (logging == true)
    {
      try 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "realtime_plot" };
    if (passedArgs != null) {
